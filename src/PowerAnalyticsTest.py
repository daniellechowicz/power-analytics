...
class PowerAnalyticsTest(unittest.TestCase):
	def setUp(self):
...
class ParametersWindowTest(unittest.TestCase):
	...
	def test_line_edits_with_metadata(self):
		...
		self.assertEqual(self.form.ui.le_moisture_content.text(), metadata["moisture_content"])
		self.assertEqual(self.form.ui.le_cutting_direction.text(), metadata["cutting_direction"])
		self.assertEqual(self.form.ui.le_rotational_speed.text(), metadata["rotational_speed"])
		self.assertEqual(self.form.ui.le_feed_speed.text(), metadata["feed_speed"])
		self.assertEqual(self.form.ui.le_cutting_width.text(), metadata["cutting_width"])
		self.assertEqual(self.form.ui.le_cutting_depth.text(), metadata["cutting_depth"])
		self.assertEqual(self.form.ui.le_cutting_angle.text(), metadata["cutting_angle"])
