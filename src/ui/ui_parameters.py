...
"}")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_2.setText(QCoreApplication.translate("MainWindow", u"Eingabe der Versuchsparameter", None))
        self.label_3.setText(QCoreApplication.translate("MainWindow", u"Autor", None))
        self.le_author.setText("")
        self.le_author.setPlaceholderText(QCoreApplication.translate("MainWindow", u"Autor", None))
        self.label_4.setText(QCoreApplication.translate("MainWindow", u"Werkstoff", None))
        self.le_material.setPlaceholderText(QCoreApplication.translate("MainWindow", u"Werkstoff", None))
        self.label_5.setText(QCoreApplication.translate("MainWindow", u"Feuchtigkeit [%]", None))
        self.le_moisture_content.setPlaceholderText(QCoreApplication.translate("MainWindow", u"Feuchtigkeit [%]", None))
        self.label_6.setText(QCoreApplication.translate("MainWindow", u"Schnittrichtung", None))
        self.le_cutting_direction.setPlaceholderText(QCoreApplication.translate("MainWindow", u"Schnittrichtung", None))
        self.label_13.setText(QCoreApplication.translate("MainWindow", u"Drehzahl [U/min]", None))
        self.le_rotational_speed.setPlaceholderText(QCoreApplication.translate("MainWindow", u"Drehzahl [U/min]", None))
        self.label_7.setText(QCoreApplication.translate("MainWindow", u"Vorschubgeschwindigkeit [m/min]", None))
        self.le_feed_speed.setPlaceholderText(QCoreApplication.translate("MainWindow", u"Vorschubgeschwindigkeit [m/min]", None))
        self.label_8.setText(QCoreApplication.translate("MainWindow", u"Schnittbreite [mm]", None))
        self.le_cutting_width.setPlaceholderText(QCoreApplication.translate("MainWindow", u"Schnittbreite [mm]", None))
        self.label_9.setText(QCoreApplication.translate("MainWindow", u"Schnitttiefe [mm]", None))
        self.le_cutting_depth.setPlaceholderText(QCoreApplication.translate("MainWindow", u"Schnitttiefe [mm]", None))
        self.label_10.setText(QCoreApplication.translate("MainWindow", u"Schnittwinkel [\u00b0]", None))
        self.le_cutting_angle.setPlaceholderText(QCoreApplication.translate("MainWindow", u"Schnittwinkel [\u00b0]", None))
        self.label_11.setText(QCoreApplication.translate("MainWindow", u"ID-Nummer", None))
        self.le_tool_id.setPlaceholderText(QCoreApplication.translate("MainWindow", u"ID-Nummer", None))
        self.label_12.setText(QCoreApplication.translate("MainWindow", u"Kommentare", None))
        self.le_comments.setPlaceholderText(QCoreApplication.translate("MainWindow", u"Kommentare", None))
        self.pushButton.setText(QCoreApplication.translate("MainWindow", u"Schlie\u00dfen", None))
        self.pushButton_2.setText(QCoreApplication.translate("MainWindow", u"L\u00f6schen", None))
        self.pushButton_3.setText(QCoreApplication.translate("MainWindow", u"Best\u00e4tigen", None))
    # retranslateUi
