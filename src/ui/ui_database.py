...
"border-radius: 17.0px;")
        ...
        self.tableWidget.setStyleSheet(u"background-color: rgba(255, 255, 255, 0);\n"
"font-size: 10pt;\n"
"font-family: \"Segoe UI Light\";\n"
"color: rgb(0, 0, 0);")
...
"}")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_2.setText(QCoreApplication.translate("MainWindow", u"Erkunden der in der Datenbank verf\u00fcgbaren Daten", None))
        self.pushButton.setText(QCoreApplication.translate("MainWindow", u"Schlie\u00dfen", None))
        self.pushButton_2.setText(QCoreApplication.translate("MainWindow", u"Speichern als CSV", None))
    # retranslateUi
