...
"}")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_2.setText(QCoreApplication.translate("MainWindow", u"Werkzeugparameter in der Datenbank bearbeiten", None))
        self.label_29.setText(QCoreApplication.translate("MainWindow", u"Suche nach ID", None))
        self.lineEdit.setText("")
        self.lineEdit.setPlaceholderText(QCoreApplication.translate("MainWindow", u"ID-Nummer", None))
        self.btn_search.setText(QCoreApplication.translate("MainWindow", u"Suchen", None))
        self.btn_add.setText(QCoreApplication.translate("MainWindow", u"Hinzuf\u00fcgen", None))
        self.groupBox.setTitle(QCoreApplication.translate("MainWindow", u"Verf\u00fcgbare Parameter", None))
        self.l_bore_diameter.setText("")
        self.label_20.setText(QCoreApplication.translate("MainWindow", u"Werkzeugk\u00f6rper-Qualit\u00e4t", None))
        self.label_15.setText(QCoreApplication.translate("MainWindow", u"Wellendurchmesser [mm]", None))
        self.l_tool_material.setText("")
        self.label_19.setText(QCoreApplication.translate("MainWindow", u"Grundk\u00f6rpermaterial", None))
        self.l_cutting_material_quality.setText("")
        self.label_16.setText(QCoreApplication.translate("MainWindow", u"Schneidenwerkstoff", None))
        self.l_cutting_material.setText("")
        self.label_7.setText(QCoreApplication.translate("MainWindow", u"Werkzeugdurchmesser [mm]", None))
        self.l_tool_diameter.setText("")
        self.label_8.setText(QCoreApplication.translate("MainWindow", u"Schneidenbreite [mm]", None))
        self.l_cutting_width.setText("")
        self.label_3.setText(QCoreApplication.translate("MainWindow", u"Klassifizierungsnummer", None))
        self.l_classification_number.setText("")
        self.label_4.setText(QCoreApplication.translate("MainWindow", u"Strategische Gesch\u00e4ftszahl", None))
        self.l_strategic_business_number.setText("")
        self.label_23.setText(QCoreApplication.translate("MainWindow", u"Max. Drehzahl [U/min]", None))
        self.label_24.setText(QCoreApplication.translate("MainWindow", u"Optimale Drehzahl [U/min]", None))
        self.l_n_max.setText("")
        self.l_n_opt.setText("")
        self.label_27.setText(QCoreApplication.translate("MainWindow", u"Spanwinkel [\u00b0]", None))
        self.l_rake_angle.setText("")
        self.label_11.setText(QCoreApplication.translate("MainWindow", u"Z", None))
        self.l_no_of_wings.setText("")
        self.groupBox_2.setTitle(QCoreApplication.translate("MainWindow", u"Bearbeiten", None))
        self.label_30.setText(QCoreApplication.translate("MainWindow", u"W\u00e4hlen Sie einen Parameter zum Aktualisieren", None))
        self.label_31.setText(QCoreApplication.translate("MainWindow", u"Zu aktualisierender Wert des Parameters", None))
        self.lineEdit_2.setPlaceholderText("")
        self.btn_close.setText(QCoreApplication.translate("MainWindow", u"Schlie\u00dfen", None))
        self.btn_update.setText(QCoreApplication.translate("MainWindow", u"Best\u00e4tigen", None))
    # retranslateUi
